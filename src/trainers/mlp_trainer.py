...
class MLPTrainer(BaseTrainer):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.loss_fn(pred=predictions, target=targets, mask=available_species_mask)
        self.log_metrics(mode="train", pred=predictions, y=targets, mask=available_species_mask)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log_metrics(mode="test", pred=predictions, y=targets, mask=available_species_mask)
